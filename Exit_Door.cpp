...
/*
    ...
    people to the left / right will only get
...
void findElements(vector<int> arr, int n)
{
    ...
    for (int i = 0; i < n; i++)
    {
        int rightsmaller = smaller_right[i];
        int leftsmaller = arr[i] - rightsmaller - 1;
        // cout << leftsmaller << ":" << rightsmaller << endl;
        res += min(leftsmaller, rightsmaller);
    }
    cout << res << endl;
}
